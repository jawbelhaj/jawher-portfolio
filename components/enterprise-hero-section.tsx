      ...
      <div className="container mx-auto px-4 py-32 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="inline-flex items-center px-6 py-3 rounded-full bg-green-500/10 border border-green-500/20 text-green-500 text-sm font-mono mb-8 hover:bg-green-500/20 transition-all duration-300 group">
            ...
            <span>Enterprise-Ready • Available for Consulting</span>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12 max-w-3xl mx-auto">
            <div className="text-center p-4 bg-gray-900/30 rounded-lg border border-green-500/10">
              <div className="text-3xl font-bold text-green-500 mb-1">
                <StatsCounter end={1} suffix="+" />
              </div>
              <div className="text-sm text-gray-400">Years Experience</div>
            </div>
            <div className="text-center p-4 bg-gray-900/30 rounded-lg border border-purple-500/10">
              <div className="text-3xl font-bold text-purple-500 mb-1">
                <StatsCounter end={4} suffix="+" />
              </div>
              <div className="text-sm text-gray-400">Projects Delivered</div>
            </div>
            <div className="text-center p-4 bg-gray-900/30 rounded-lg border border-blue-500/10">
              <div className="text-3xl font-bold text-blue-500 mb-1">
                <StatsCounter end={12} suffix="+" />
              </div>
              <div className="text-sm text-gray-400">Certifications</div>
            </div>
            <div className="text-center p-4 bg-gray-900/30 rounded-lg border border-yellow-500/10">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center mb-16">
            <EnhancedButton
              ...
              className="bg-green-500 hover:bg-green-600 text-black gap-3 px-10 py-4 text-xl font-semibold"
              glow
            >
