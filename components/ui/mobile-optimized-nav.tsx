    ...
    <>
      <header
        className={cn(
          ...
          isScrolled ? "bg-black/95 backdrop-blur-md border-b border-green-500/20" : "bg-transparent",
        )}
      >
        <div className="container mx-auto px-4 py-3 flex items-center justify-between">
          ...
          {/* Mobile menu button */}
          <button
            className="lg:hidden text-gray-300 p-2 rounded-md hover:bg-gray-800/50 transition-colors"
      ...
      {mobileMenuOpen && (
        <div className="fixed inset-0 z-50 lg:hidden">
          ...
          <div className="fixed top-0 right-0 h-full w-80 max-w-[85vw] bg-gray-900/95 backdrop-blur-md border-l border-green-500/20">
